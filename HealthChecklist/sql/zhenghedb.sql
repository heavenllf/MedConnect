...
CREATE TABLE IF NOT EXISTS `zhenghe_db`.`doctortbl` (
  ...
  `E_MAIL` VARCHAR(256) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `zhenghe_db`.`systemusertbl`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `zhenghe_db`.`systemusertbl` ;

CREATE TABLE IF NOT EXISTS `zhenghe_db`.`systemusertbl` (
